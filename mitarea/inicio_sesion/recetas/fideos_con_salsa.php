...
$nombre_receta="fideos_con_salsa";
...
<h3>Ingredientes:</h3>
<ul>
    <li>200 g de fideos (espaguetis, penne, etc.)</li>
    <li>1 lata (400 g) de tomate triturado o salsa de tomate</li>
    <li>2 dientes de ajo picados</li>
    <li>Aceite de oliva</li>
    <li>Especias: albahaca, orégano, sal y pimienta al gusto</li>
</ul>

<img src="imagen/fideos_con_salsa.jpg"/>
