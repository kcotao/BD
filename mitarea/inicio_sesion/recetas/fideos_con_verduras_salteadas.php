...
$nombre_receta="fideos_con_verduras_salteadas";
...
<h3>Ingredientes:</h3>
<ul>
    <li>200 g de fideos (espaguetis, fettuccine, etc.)</li>
    <li>Variedad de verduras al gusto (zanahorias, brócoli, champiñones, pimientos, etc.)</li>
    <li>2 cucharadas de aceite de oliva</li>
    <li>2 dientes de ajo picados</li>
    <li>Salsa de soja al gusto</li>
</ul>

<img src="imagen/fideos_con_verduras_salteadas.jpg"/>
